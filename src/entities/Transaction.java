...
public class Transaction {
	  ...
	  int tr_id;
	  String tr_number; 
	  Account tr_sender_account_id; 
	  Account tr_receiver_account_id; 
	  float tr_amount_sender; 
	  float tr_amount_receiver;
	  Date tr_date;
	  String tr_detail; 
	  boolean tr_state; 
	...
	public Transaction(int tr_id, String tr_number, Account tr_sender_account_id, Account tr_receiver_account_id,
			float tr_amount_sender, float tr_amount_receiver, Date tr_date, String tr_detail, boolean tr_state) {
		super();
		this.tr_id = tr_id;
	...
	public float getTr_amount_sender() {
		return tr_amount_sender;
	}



	public void setTr_amount_sender(float tr_amount_sender) {
		this.tr_amount_sender = tr_amount_sender;
	}



	public float getTr_amount_receiver() {
		return tr_amount_receiver;
	}



	public void setTr_amount_receiver(float tr_amount_receiver) {
		this.tr_amount_receiver = tr_amount_receiver;
	}
